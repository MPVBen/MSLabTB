...
# - REMOVED: Bootstrap functionality and weighted fitting options
...
def fit_hill(L0, ratio, fix_n_to_1=False):
    L0 = np.asarray(L0, dtype=float)
...
def fit_gabelica_corrected(C0, ratio_inverse):
    """
            ...
            if st.button("Lancer l'analyse") or st.session_state.analysis_done:
                ...
                if use_hill:
                    ...
                    if len(L0) < min_points:
                        ...
                        hill_res = fit_hill(L0, ratio_hill, fix_n_to_1=fix_n_to_1)
